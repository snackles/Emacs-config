...
(use-package lsp-mode
  :ensure t
  :hook (c++-mode c-mode rust-mode haskell-mode haskell-literate-mode js2-mode objc-mode)
  :config
...
;; Swift-режим (официальный пакет от Apple)
(use-package swift-mode
  :ensure t
  :mode ("\\.swift\\'" . swift-mode))

;; SourceKit-LSP (аналог clangd для Swift)
...
;; Автозапуск LSP для Swift-файлов
(add-hook 'swift-mode-hook #'lsp-deferred)

;; Регистрация Swift в LSP
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 110 :width normal :family "JetBrains Mono"))))
